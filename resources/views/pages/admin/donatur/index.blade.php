...
<div class="container-xxl flex-grow-1 container-p-y">
    ...
    <div class="card mb-4">
        ...
        <div>
            ...
            <small class="text-muted">Daftar Donatur.</small>
        </div>
        @can('donatur-create')
          <a href="{{ route('donatur.create') }}" class="btn btn-primary rounded-pill d-flex align-items-center">
        ...
        <div class="card-body">
                ...
                <table class="table table-hover align-middle">
                  ...
                  @foreach ($data as $item)
                      <tr class="product-row">
                        ...
                        <td>
                            <div class="btn-group">
                            {{-- <a class="btn btn-outline-secondary btn-sm" href="{{ route('donatur.show',$item->id) }}">
                                <i class="fa-solid fa-list"></i>
                            </a> --}}
                            @can('donatur-edit')
                                <a class="btn btn-outline-primary btn-sm" href="{{ route('donatur.edit',$item->id) }}">
            ...
            <div class="text-center p-5">
                ...
                <h5 class="mb-1">Belum ada Donatur</h5>
                <p class="text-muted mb-3">Mulai tambahkan Donatur pertama Anda, untuk muncul di daftar.</p>
                <a href="{{ route('donatur.create') }}" class="btn btn-primary rounded-pill">
                <i class="bx bx-plus me-1"></i> Tambah Donatur
                </a>
            </div>
            @endif
