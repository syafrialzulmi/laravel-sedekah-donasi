...
@section('title', 'Program Sedekah')

@section('main')

<div class="container-xxl flex-grow-1 container-p-y">
    <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Master /</span> Program Sedekah</h4>

    <div class="card mb-4">
        <div class="card-header d-flex align-items-center justify-content-between">
        <div>
            <h5 class="mb-0">Program Sedekah</h5>
            <small class="text-muted">Daftar Program Sedekah.</small>
        </div>
        @can('program-sedekah-create')
          <a href="{{ route('program-sedekah.create') }}" class="btn btn-primary rounded-pill d-flex align-items-center">
        ...
        <div class="card-body">
            ...
            <div class="input-group" style="max-width: 420px;">
                ...
                @if(request()->filled('q'))
                <a href="{{ route('program-sedekah.index', ['ps' => request('ps', 10)]) }}" class="btn btn-light">Reset</a>
                @endif
            </div>
                ...
                <table class="table table-hover align-middle">
                  ...
                  @foreach ($data as $item)
                      ...
                      <td>
                        ...
                        <td>
                            <div class="btn-group">
                            {{-- <a class="btn btn-outline-secondary btn-sm" href="{{ route('program-sedekah.show',$item->id) }}">
                                <i class="fa-solid fa-list"></i>
                            </a> --}}
                            @can('program-sedekah-edit')
                                <a class="btn btn-outline-primary btn-sm" href="{{ route('program-sedekah.edit',$item->id) }}">
                                <i class="fa-solid fa-pen-to-square"></i>
                                </a>
                            @endcan
                            @can('program-sedekah-delete')
                                <button type="button"
                                class="btn btn-outline-danger btn-sm btn-open-delete"
                                data-url="{{ route('program-sedekah.destroy',$item->id) }}"
                                data-name="{{ $item->nama_program }}"
            ...
            <div class="text-center p-5">
                ...
                <h5 class="mb-1">Belum ada Program Sedekah</h5>
                <p class="text-muted mb-3">Mulai tambahkan Program Sedekah pertama Anda, untuk muncul di daftar.</p>
                <a href="{{ route('program-sedekah.create') }}" class="btn btn-primary rounded-pill">
                <i class="bx bx-plus me-1"></i> Tambah Program Sedekah
                </a>
            </div>
            @endif
